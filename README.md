graphql-client
===
SDL Digital Experience Accelerator GraphQL client for Java

About
-----
The GraphQL client provides a public content API for the Java DXA framework in order to retrieve content from the new GraphQL endpoint exposed by the content service.
